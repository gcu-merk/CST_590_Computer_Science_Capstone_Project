...
This module is being migrated to the new edge-processing structure.
For the main speed analysis service, see: edge-processing/speed-analysis/speed_analysis_service.py
"""
...
sys.path.append(str(Path(__file__).parent.parent.parent / "edge-processing"))
...
try:
    ...
    print("Please ensure the edge-processing modules are properly installed.")
...
if __name__ == "__main__":
    ...
    print("Redirecting to new edge-processing service...")
